...
public partial class CrossPlatformInputManager
    {
        ...
        public static bool GetButtonLongPressed(string name)
        {
            return virtualInput.GetButtonLongPressed(name);
        }
		...
		public class VirtualButton:SmartPointer
        {
            ...
            private int longPressedFrame = -5;
            ...
            public void LongPressed()
            {
                ...
                longPressedFrame = Time.frameCount;
            }
            ...
            public bool GetButtonLongPressed
            {
                get
                {
                    return (longPressedFrame == Time.frameCount - 1);
                }
            }
        }
    }
